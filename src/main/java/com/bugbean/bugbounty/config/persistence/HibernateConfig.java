package com.bugbean.bugbounty.config.persistence;
...
@EnableJpaRepositories("com.bugbean.bugbounty.repository")
    ...
    public SessionFactory createAndGetLocalSessionFactoryBean() {
        if (this.sessionFactory == null) {
            try {
                ...
                configuration.addPackage("com.bugbean.bugbounty.model");
                for (Class<?> clazz : (new Reflections("com.bugbean.bugbounty.model")).getTypesAnnotatedWith(Entity.class)) {
